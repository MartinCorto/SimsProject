...
LIEU initialisationCuisine(void)
{
	...
	evtCuisine4->duree_evt = 0;
	evtCuisine4->sante = -2;
	evtCuisine4->prix = 0;
	evtCuisine4->sommeil = -5;
	evtCuisine4->moral = -5;
	evtCuisine4->faim = -2;
	evtCuisine4->hygiene = 0;
...
void initialisationLieux(LIEU place[7]){
	...
	LIEU * lieu;
	lieu=malloc(sizeof(LIEU));
	
	place[0]=initialisationCuisine();
	
	//place[0]=*lieu;
	lieu=malloc(sizeof(LIEU));
	afficheLIEU(place[0]);
	lieu=initialisationChambre(lieu);
	
	place[1]=*lieu;
	lieu=malloc(sizeof(LIEU));
	afficheLIEU(place[1]);
	lieu=initialisationSalleDeBain(lieu);
	
	place[2]=*lieu;
	lieu=malloc(sizeof(LIEU));
	afficheLIEU(place[2]);
	lieu=initialisationCellier(lieu);
	
	place[3]=*lieu;
	lieu=malloc(sizeof(LIEU));
	afficheLIEU(place[3]);
	lieu=initialisationExterieur(lieu);
	
	place[4]=*lieu;
	lieu=malloc(sizeof(LIEU));
	afficheLIEU(place[4]);
	lieu=initialisationJardin(lieu);
